...
function App() {
  ...
  const apiEndpoint = "https://olympicmedalsapi-hwhwa9eecffugeg7.northcentralus-01.azurewebsites.net/jwtapi/country";
  const hubEndpoint = "https://olympicmedalsapi-hwhwa9eecffugeg7.northcentralus-01.azurewebsites.net/medalsHub";
  ...
  return (
    <Theme appearance={appearance}>
      ...
      {user.authenticated ? (
        <Logout onLogout={handleLogout} username={user.name} />
      ) : (
